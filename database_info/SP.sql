...
BEGIN
UPDATE duenos 
SET NUMERO_IDENTIFICACION = NUMERO_IDENTIFICACION,NOMBRES= NOMBRES ,APELLIDOS = APELLIDOS ,DIRECCION=DIRECCION,
BARRIO=BARRIO,EMAIL=EMAIL,TELEFONO=TELEFONO,ID_TIPO_IDENTIFICACION=ID_TIPO_IDENTIFICACION 
WHERE ID_DUENOS = ID_DUENO;
END//
DELIMITER ;


CALL SP_ACTUALIZAR_DUENOS('111111111','KevinPrueba','RestrepoPrueba','Cr prueba # prueba','prueba#1','kevinresca@prueba.com','318prueba123',1,13);
...
IN `SEXO` VARCHAR(50),
IN `ID_RAZA` INT,
IN `DUENOS_ID` VARCHAR(100)
)
COMMENT 'Procedimiento almacenado para agregar mascotas.'
BEGIN
INSERT INTO MASCOTAS (NOMBRE,PESO,FECHA_NACIMIENTO,SEXO,ID_RAZA,ID_DUENO ) VALUES (NOMBRE,PESO,FECHA_NACIMIENTO,SEXO,ID_RAZA,
(SELECT ID_DUENOS FROM duenos WHERE NUMERO_IDENTIFICACION = DUENOS_ID));
END//
DELIMITER ;


CALL SP_AGREGAR_MASCOTAS('XXXX','5 KG','2018-01-01','MACHO',23,963258741);
